...
const paymentSchema = new mongoose.Schema(
  {
    ...
    // Type of payment - quiz entry, lifetime PDF access, or free-credit entry
    paymentType: {
      type: String,
      enum: ["QUIZ_ENTRY", "PDF_ACCESS", "FREE_CREDIT"],
      default: "QUIZ_ENTRY",
      index: true
    },

    // Optional explicit quiz reference (for future extensibility)
    quiz: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "Quiz",
      default: null
